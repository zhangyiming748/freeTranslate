...
func TestProxy(t *testing.T) {
	uri := "https://stackoverflow.com/questions/28523975/change-all-file-icons-with-same-type-yosemite"
	proxy := "http://127.0.0.1:8889"
	withProxy, err := GetWithProxy(uri, proxy)
	if err != nil {
		return
	}
	t.Log(withProxy)
