...
import (
	...
	"os/exec"
	"path"
	"processAVIWithXorm/GBK2UTF8"
	"processAVIWithXorm/GetAllFolder"
	"processAVIWithXorm/GetFileInfo"
	"processAVIWithXorm/alert"
	"processAVIWithXorm/merge"
	"processAVIWithXorm/model"
	"processAVIWithXorm/processAudio"
	"processAVIWithXorm/processImage"
	"processAVIWithXorm/processVideo"
	"processAVIWithXorm/storage/mysql"
	"processAVIWithXorm/telegraph"
	"processAVIWithXorm/util"
	"processAVIWithXorm/ytdlp"
	"runtime"
	"strings"
	"time"
)
